...
import cc.devcp.project.config.server.model.SampleResult;
import cc.devcp.project.config.server.monitor.MetricsMonitor;
import cc.devcp.project.config.server.utils.GroupKey;
import cc.devcp.project.config.server.utils.LogUtil;
import cc.devcp.project.config.server.utils.MD5Util;
import cc.devcp.project.config.server.utils.RequestUtil;
import cc.devcp.project.config.server.utils.event.EventDispatcher.AbstractEventListener;
...
import static cc.devcp.project.config.server.utils.LogUtil.pullLog;
    ...
    public LongPollingService() {
        ...
        scheduler = Executors.newScheduledThreadPool(1, new ThreadFactory() {
            ...
            public Thread newThread(Runnable r) {
                ...
                t.setDaemon(true);
                t.setName("cc.devcp.project.LongPolling");
                return t;
            }
        });
