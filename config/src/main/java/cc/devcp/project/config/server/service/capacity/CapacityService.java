package cc.devcp.project.config.server.service.capacity;

import cc.devcp.project.config.server.constant.CounterMode;
import cc.devcp.project.config.server.model.capacity.Capacity;
import cc.devcp.project.config.server.model.capacity.GroupCapacity;
import cc.devcp.project.config.server.model.capacity.TenantCapacity;
...
import cc.devcp.project.config.server.utils.TimeUtils;
...
public class CapacityService {
    ...
    public void init() {
        ...
        ThreadFactory threadFactory = new ThreadFactoryBuilder().setNameFormat(
            "cc.devcp.project.CapacityManagement-%d").setDaemon(true).build();
