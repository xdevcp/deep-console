...
import cc.devcp.project.config.server.enums.FileTypeEnum;
...
import cc.devcp.project.config.server.utils.ParamUtils;
...
public class PersistService {
     ...
     * @Date 2019/7/5 16:37
     * @Param [ids]
     * @return java.util.List<cc.devcp.project.config.server.model.ConfigInfo>
     */
    ...
    public Map<String, Object> batchInsertOrUpdate(List<ConfigAllInfo> configInfoList, String srcUser, String srcIp,
                                                   Map<String, Object> configAdvanceInfo, Timestamp time, boolean notify, SameConfigPolicy policy) throws GlobalException {
        int succCount = 0;
        int skipCount = 0;
