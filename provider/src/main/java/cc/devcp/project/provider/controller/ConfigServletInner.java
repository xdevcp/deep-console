...
import cc.devcp.project.provider.service.ConfigService;
import cc.devcp.project.provider.service.DiskUtil;
import cc.devcp.project.provider.service.LongPollingService;
...
public class ConfigServletInner {
    ...
    public String doGetConfig(HttpServletRequest request, HttpServletResponse response, String dataId, String group,
        ...
        if (lockResult > 0) {
            ...
            LogUtil.pullLog.info("[client-get] clientIp={}, {}, get data during dump", clientIp, groupKey);
