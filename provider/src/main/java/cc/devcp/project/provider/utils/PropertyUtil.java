...
public class PropertyUtil {
    ...
    public static final String MYSQL_PROPERTY_KEY = "mysql";
    ...
    public static boolean isStaticUseMysql() {
        return standaloneUseMysql;
    }

    public static boolean isStaticUseDerby() {
        return !standaloneUseMysql;
    }

    public boolean isStandaloneUseMysql() {
        return standaloneUseMysql;
    }
