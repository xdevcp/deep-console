 ...
 * @since 0.2.2
 */
public class AppDefaultPropertySourceEnvironmentPostProcessor implements EnvironmentPostProcessor, Ordered {

    /**
     * The name of Nacos default {@link PropertySource}
     */
    public static final String PROPERTY_SOURCE_NAME = "app-default";
    ...
    public static final String RESOURCE_LOCATION_PATTERN = CLASSPATH_ALL_URL_PREFIX
        + "META-INF/app-default.properties";
