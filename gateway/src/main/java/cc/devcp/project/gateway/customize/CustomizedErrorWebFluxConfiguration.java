...
public class CustomizedErrorWebFluxConfiguration {
    ...
    public CustomizedErrorWebFluxConfiguration(ServerProperties serverProperties,
    ...
    public ErrorWebExceptionHandler errorWebExceptionHandler(ErrorAttributes errorAttributes) {
        ...
        CustomizedErrorWebExceptionHandler exceptionHandler = new CustomizedErrorWebExceptionHandler(
                errorAttributes,
                resourceProperties,
