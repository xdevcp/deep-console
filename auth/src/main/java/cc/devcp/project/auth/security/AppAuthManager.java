package cc.devcp.project.auth.security;

import cc.devcp.project.auth.security.auth.AccessException;
import cc.devcp.project.auth.security.auth.Account;
import cc.devcp.project.auth.security.auth.AuthManager;
import cc.devcp.project.auth.security.auth.Permission;
import cc.devcp.project.auth.security.roles.AppRoleServiceImpl;
import cc.devcp.project.auth.security.users.AppUser;
...
public class AppAuthManager implements AuthManager {
    ...
    @Override
    public Account login(Object request) throws AccessException {
    ...
    @Override
    public void auth(Permission permission, Account user) throws AccessException {
