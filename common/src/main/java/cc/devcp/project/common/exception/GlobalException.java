...
public class GlobalException extends Exception {
    ...
    public GlobalException(int errCode, String errMsg) {
        super(errMsg);
        this.errCode = errCode;
        this.errMsg = errMsg;
    }

    public GlobalException(int errCode, Throwable throwable) {
        super(throwable);
        this.errCode = errCode;
        setCauseThrowable(throwable);
    }

    public GlobalException(int errCode, String errMsg, Throwable throwable) {
